...
public class ScrollableCam : MonoBehaviour
{
    ...
    private float mapHalfWidth, mapHalfHeight, camHalfWidth, camHalfHeight, camHalfWidthY, mapHalfWidthY;
    ...
    private void ProcessDrag()
    {
        ...
        mapHalfWidthY = (map.GetComponent<MeshFilter>().mesh.bounds.size.y * map.transform.localScale.y / 2);
        camHalfHeight = 2f * cam.orthographicSize / 2;
        camHalfWidth = camHalfHeight * cam.aspect;
        camHalfWidthY = camHalfHeight * cam.aspect;
        ...
        minY = mapCenter.y - mapHalfWidthY + camHalfWidthY;
        maxY = mapCenter.y + mapHalfWidthY - camHalfWidthY;
